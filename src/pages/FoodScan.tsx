...
export default function FoodScan(){
 ...
 const [photo,setPhoto]=useState<string|null>(null); const [result,setResult]=useState<any>(null); const [busy,setBusy]=useState(false); const [error,setError]=useState(''); const [barcodeManual,setBarcodeManual]=useState(''); const [barcodeGrams,setBarcodeGrams]=useState(100);
