...
export default function NutritionGoals() {
  ...
  /*
   * IMPORTANT :
   * on ouvre directement l'éditeur personnel
   * dans la page Moi.
   */
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          NOX utilise ton profil et ton objectif pour
          te proposer un cap adapté à ta journée.
        </p>
        ...
        {!loading && recommendation && profile && (
          <>
            <div
              style={{
                borderRadius: 26,
            ...
            >
              Estimation basée sur ton profil NOX.
              Elle pourra évoluer avec tes données et
              ta progression.
            </div>
          </>
        )}
        ...
        {!loading && !recommendation && (
          ...
          >
            ...
            >
              Il manque quelques informations à NOX.
            </div>
            ...
            >
              Complète ton profil pour que NOX puisse
              calculer automatiquement ton cap
              nutritionnel.
            </div>
        ...
        {!loading &&
          ...
          recommendation && (
            ...
            >
              ...
              >
                {existingTargets.calories ?? '—'} kcal ·{' '}
                {existingTargets.protein_g ?? '—'} g
                protéines ·{' '}
                {existingTargets.carbs_g ?? '—'} g
                glucides ·{' '}
                {existingTargets.fat_g ?? '—'} g
                lipides
              </div>
            </div>
          )}
