    ...
    <main style={{maxWidth:720,margin:'0 auto',padding:'18px'}}>
      {step==='setup' && <>
        ...
        <Card title="Allergies & intolérances" sub="Contrainte prioritaire. NOX exclut les aliments manifestement incompatibles.">
          <div style={{background:'#fff7e8',border:'1px solid #f3dfb5',borderRadius:14,padding:12,fontSize:11,color:'#765b24',lineHeight:1.5,marginBottom:12}}>Avertissement : Pour un produit emballé, vérifie toujours l'étiquette et les mentions traces de. La liste ne remplace pas les informations allergènes du fabricant.</div>
